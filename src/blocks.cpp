...
block::block(ofTag & cur,ofColor col, int _y):ofInterObj(300,100,150,45) {
...
bool block::below(int _x,int _y,int dispx, int dispy){
	...
	(_y+dispy)>y+h-10&&(_y+dispy)<y+h+15;
}
