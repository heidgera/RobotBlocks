...
void bGroup::draw(){
	...
	for (unsigned int i=0; i<size(); i++) {
		/*if(i==lastBlock&&!blocks[i].grabbed){
			blocks[i].drawSelected();
			//int hgt=blocks[i].heightOnlyOn()+blocks[i].h;
//			ofSetColor(0,0,0);
//			ofRingSegment(blocks[i].x+10, blocks[i].y+hgt, 18, 24, 0, 180);
//			ofRect(blocks[i].x-24+10, blocks[i].y, 6, hgt);
//			ofRingSegment(blocks[i].x+10, blocks[i].y, 18, 24, 180, 360);
//			ofTriangle(blocks[i].x+22, blocks[i].y-4, blocks[i].x+40, blocks[i].y-4, blocks[i].x+31, blocks[i].y+4);
//			ofSetColor(0, 255, 100);
//			ofTriangle(blocks[i].x+25, blocks[i].y-3, blocks[i].x+37, blocks[i].y-3, blocks[i].x+31, blocks[i].y+2);
//			ofRingSegment(blocks[i].x+10, blocks[i].y+hgt, 20, 22, 0, 180);
//			ofRect(blocks[i].x-22+10, blocks[i].y, 2, hgt);
//			ofRingSegment(blocks[i].x+10, blocks[i].y, 20, 22, 180, 360);
			ofSetColor(60, 128, 0);
			rTop.draw(blocks[i].x-13, blocks[i].y-rTop.height);
			rBot.draw(blocks[i].x-13, blocks[i].y+hgt);
			rSide.draw(blocks[i].x-13, blocks[i].y-8,rSide.width,hgt+8);
		}*/
